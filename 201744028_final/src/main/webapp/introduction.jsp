...
<h1 style="font-size: 40px; font-weight:bold">&emsp;사이트 소개</h1>
<div class="container">
 	<div class="jumbotron">
 		<div class="container">
 			<section class="item item-a">
 				<h1>Playwiki 소개</h1><br>
 				<p>Playwiki는 사용자들이 채워나가는 게임 공략 / 소통 장소입니다.  </p>
 				<p>사이트이름은 게임을 플레이하다의 "Play"와 Wiki라는 용어를 결합한 이름입니다.  </p>
 				<p>사이트를 통해 사람들간 게임정보, 공략들을 서로 알려주며 소통하는 장소입니다. </p>
